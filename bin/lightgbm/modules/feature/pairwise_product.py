"""Pairwise products of top-variance numeric features.

Picks up to 8 numeric columns with the largest train variance and adds all
pairwise products as new numeric columns. Bounded by C(K,2)=28 extra
columns. This gives LightGBM explicit interaction features that single
trees model only approximately through deep splits.
"""
