# ruff: noqa
"""Standalone implementation for ``categorical_preprocess_rare_missing``."""
...
def categorical_preprocess_rare_missing(
    x_cat: dict[str, np.ndarray] | None, _config: dict[str, Any] | None = None
) -> tuple[dict[str, np.ndarray] | None, dict[str, object]]:
    return _categorical_preprocess_variant(x_cat, mode='rare_missing')
