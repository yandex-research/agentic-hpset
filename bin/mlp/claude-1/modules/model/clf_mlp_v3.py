...
class GLUBlock(nn.Module):
    """Single MLP block with gated linear unit activation.

    Linear from d_in to 2 * d_out, split, gate one half with sigmoid
    over the other. Replaces ReLU+Linear pattern with multiplicative
    gating, which has been shown to help capture feature interactions.
    """
