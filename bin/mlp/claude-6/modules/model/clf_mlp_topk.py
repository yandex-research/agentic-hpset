...
class TopKActivation(nn.Module):
    def __init__(self, k_ratio: float = 0.5) -> None:
        super().__init__()
...
class MLPTopKModel(nn.Module):
    def __init__(
        ...
        k_ratio = float(params.get('topk_ratio', 0.5))
