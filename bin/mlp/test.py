#!/usr/bin/env python
"""Generated-data smoke and interaction tests for the modular MLP pipeline.
...
`bin.mlp.pipeline.train_and_eval`, and reports correctness + efficiency vs the
...
from bin.mlp.pipeline import train_and_eval
...
def base_trial_params(batch_size: int, epochs: int, patience: int | None) -> dict[str, Any]:
    ...
    Mirrors the keys produced by `bin.mlp.hparams.sample_hps`; exploring these
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Generated-data smoke and interaction tests for the modular MLP pipeline.')
